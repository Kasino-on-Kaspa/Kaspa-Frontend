...
export const highWinColumns: ColumnDef<GameWin>[] = [
  {
    header: "Player",
...
export default function HighWinTable({ wins }: HighWinTableProps) {
  return <DataTable columns={highWinColumns} data={wins} />;
}
